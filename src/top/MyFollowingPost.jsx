...
export default function MyFollowingPost({changeProfile}) {
        ...
        return(
          ...
          <div className="card-header">
            <div className="card-pic">
              <img src={posts.postedBy.photo?posts.postedBy.photo:picLink} onClick={changeProfile} alt="" />
            </div>
            <h5>
